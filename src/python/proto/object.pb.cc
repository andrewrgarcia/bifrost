...
const ::_pbi::DescriptorTable descriptor_table_proto_2fobject_2eproto = {
    ...
    file_level_metadata_proto_2fobject_2eproto, file_level_enum_descriptors_proto_2fobject_2eproto,
    file_level_service_descriptors_proto_2fobject_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_2fobject_2eproto_getter() {
  return &descriptor_table_proto_2fobject_2eproto;
}
...
uint8_t* Object::_InternalSerialize(
  ...
  // repeated int32 array_field = 2;
  {
    int byte_size = _impl_._array_field_cached_byte_size_.Get();
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          2, _internal_array_field(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:Object)
  ...
  // repeated int32 array_field = 2;
  {
    ...
    _impl_._array_field_cached_byte_size_.Set(cached_size);
...
::PROTOBUF_NAMESPACE_ID::Metadata Object::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2fobject_2eproto_getter, &descriptor_table_proto_2fobject_2eproto_once,
      file_level_metadata_proto_2fobject_2eproto[0]);
}
